...
# File: APP_DIR/app/models/photo.rb
  validates_attachment :image, presence: true, # validates if file is proper image
  content_type: { content_type: ["image/jpeg", "image/gif", "image/png"] },  # whitelist content type
 ...
 # to your APP_DIR/config/environments/development.rb
